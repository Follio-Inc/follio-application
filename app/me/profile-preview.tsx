...
import { Edit, ExternalLink, Eye, LayoutDashboard, Settings } from 'lucide-react';
...
import { RecruiterView } from '@/app/u/[handle]/views/recruiter-view';
          ...
          <div className="container flex h-14 items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/dashboard" className="flex items-center gap-2 text-sm font-medium">
                ...
                <span className="hidden sm:inline">Follio</span>
              </Link>
