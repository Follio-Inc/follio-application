      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            'ease-[cubic-bezier(0.16,1,0.3,1)] transition-[opacity,transform,box-shadow,background-color] duration-500',
      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            'ease-[cubic-bezier(0.16,1,0.3,1)] transition-[opacity,color,background-color,border-color,box-shadow,transform] duration-500',
