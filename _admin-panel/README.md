...
| Module        | Path                 | Status                                                            |
| ------------- | -------------------- | ----------------------------------------------------------------- |
| **Developer** | `modules/developer/` | Health, Vitest suites, Live QA, resume reader, smoke, quick links |
...
- `app/api/admin/developer/*` (including `live-qa/*` and `ai/resume-reader`)
